...
class CartTest {
    ...
    void testCheckoutCart() {
        Book book1 = createBook("Book X", "Series A", "Description 1", new HashSet<>(List.of("Author 1")), new HashSet<>(List.of("Genre 1")));
        Book book2 = createBook("Book Y", "Series B", "Description 2", new HashSet<>(List.of("Author 2")), new HashSet<>(List.of("Genre 2")));
    ...
    void testShallowCopyCart() {
        List<Book> initialBooks = Arrays.asList(
                createBook("Book X", "Series A", "Description 1", new HashSet<>(List.of("Author 1")), new HashSet<>(List.of("Genre 1"))),
                createBook("Book Y", "Series B", "Description 2", new HashSet<>(List.of("Author 2")), new HashSet<>(List.of("Genre 2")))
        );
